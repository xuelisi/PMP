        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="名称">
              <a-input placeholder="请输入名称" v-model="queryParam.taskname"></a-input>
            </a-form-item>
    ...
    <div class="table-operator">
      <a-dropdown-button @click="handleAdd">
        ...
        <a-menu slot="overlay">
          ...
          <a-menu-item key="2">
            <a-icon type="download" @click="handleExportXls('我的任务')" />导出
          </a-menu-item>
        </a-menu>
      </a-dropdown-button>
    ...
    <div>
      ...
      >
        <template slot="taskname" slot-scope="text,record">
          <a href="javascript:;" @click="handleDetail(record)">{{text}}</a>
        </template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/task/pmpTaskdetails/list',
        delete: '/task/pmpTaskdetails/delete',
        deleteBatch: '/task/pmpTaskdetails/deleteBatch',
        exportXlsUrl: '/task/pmpTaskdetails/exportXls',
        importExcelUrl: 'task/pmpTaskdetails/importExcel'
      },
      dictOptions: {
        emergencylevel: []
      }
