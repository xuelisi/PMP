...
export const asyncRouterMap = [
  ...
  //       name: 'project',
  //       component: RouteView,
  //       meta: { title: '项目', permission: ['jeecg'] },
  //       children: [
  //         {
  //           path: '/jeecg/project/myproject_task',
  //           name: 'myproject_task',
  //           component: () => import('@/views/jeecg/project/myproject_task'),
  //           meta: { title: '项目分发任务', permission: ['jeecg'] }
  //         },
  //         {
  //           path: '/jeecg/project/myproject',
  //           name: 'myproject',
  //           component: () => import('@/views/jeecg/project/myproject'),
  //           meta: { title: '我的项目', permission: ['jeecg'] }
  //         },
